...
const passswordRef = useRef(null);
  ...
  const copyPasswordToClip = useCallback(()=>{
    ...
    passswordRef.current?.setSelectionRange(0,9)
 ...
 useEffect(()=>{passwordGenerator()},[length ,numberAllowed ,charAllowed ,passwordGenerator])
  ...
  return (
    ...
    <input type="text" value={password} className='outline-none w-full py-1 px-3' placeholder="password" readonly ref={passswordRef}/>
    <button onClick={copyPasswordToClip} className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0'>copy</button>
     ...
     <div className='flex text-sm gap-x-2'>
      ...
      <div className='flex items-center gap-x-1'>
        ...
        <label htmlFor="njumberInput">Numbers</label>
